...
namespace SDK {
    ...
    void Patterns::InitPatterns() {
        ...
        gPatterns.C_SlotWrapper__LoadDataAddr =
            reinterpret_cast<uint64_t>(hook::pattern("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B 41 ? 41 8B F9 49 8B F0 48 8B EA").get_first());
        ...
        gPatterns.C_HumanSpawner__SetupDefaultArchetypeObjectAddr =
            reinterpret_cast<uint64_t>(hook::pattern("4C 8B DC 49 89 5B ? 56 57 41 56 48 83 EC ? 48 8B 1D ? ? ? ?").get_first());
        ...
        gPatterns.C_ProfileSpawner__IsSpawnProfileLoadedAddr =
            reinterpret_cast<uint64_t>(hook::pattern("48 89 5C 24 ? 57 48 83 EC ? 48 8B D9 E8 ? ? ? ? 48 8B C8 48 8D 54 24 ? E8 ? ? ? ? 4C 8D 83 ? ? ? ?").get_first());
        ...
        gPatterns.C_WeatherManager2__GetDayTimeHoursAddr =
            reinterpret_cast<uint64_t>(hook::pattern("F3 0F 10 81 ? ? ? ? F3 0F 59 05 ? ? ? ? C3 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? F3 0F 10 81 ? ? ? ?").get_first());
        gPatterns.C_WeatherManager2__GetDayTimeRelAddr =
            reinterpret_cast<uint64_t>(hook::pattern("F3 0F 10 81 ? ? ? ? F3 0F 59 05 ? ? ? ? C3 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? 48 8B 41 ?").get_first());
        gPatterns.C_WeatherManager2__SetDayTimeHoursAddr =
        ...
        gPatterns.C_Matrix__SetRotAddr  = reinterpret_cast<uint64_t>(
            hook::pattern("40 53 48 83 EC ? 48 8B D9 E8 ? ? ? ? 33 C0 89 43 ? 89 43 ? 89 43 ? 48 83 C4 ? 5B C3 ? 40 53 48 83 EC ? 48 8B D9 E8 ? ? ? ?").get_first());
        gPatterns.C_Matrix__SetRotEulerAddr =
            reinterpret_cast<uint64_t>(hook::pattern("40 53 48 83 EC ? 48 8B D9 E8 ? ? ? ? 33 C0 89 43 ? 89 43 ? 89 43 ? 48 83 C4 ? 5B C3 ? 0F 10 02").get_first());
        ...
        gPatterns.C_HumanScript__GetOffVehicle =
            hook::get_opcode_address("E8 ? ? ? ? 48 8B 4C 24 ? 48 85 C9 74 ? 83 69 ? ? 75 ? 48 8B 01 FF 50 ? 48 8B 8B ? ? ? ? 4C 8D 05 ? ? ? ?");
        ...
        gPatterns.C_Car__OpenHood =
            hook::get_opcode_address("E8 ? ? ? ? 33 C0 48 83 C4 ? 5B C3 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? 40 53 48 83 EC ? 45 33 C0 33 D2 48 8B D9 E8 ? ? ? ? 48 8B 43 ? C7 40 ? ? ? ? "
                                     "? C7 00 ? ? ? ? 48 83 C0 ? 48 89 43 ? B8 ? ? ? ? 48 83 C4 ? 5B C3 ? ? ? ? ? ? ? ? ? 48 83 EC ?");
#endif

        gPatterns.C_Car__CloseHood = reinterpret_cast<uint64_t>(
            hook::pattern("48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC ? 48 8B 81 ? ? ? ? 33 DB 48 2B 81 ? ? ? ? 33 FF 48 C1 F8 ? 48 8B F1 4C 63 F0 85 C0 0F 8E ? ? ? "
        ...
        gPatterns.C_Vehicle__DamageBreaks =
            reinterpret_cast<uint64_t>(hook::pattern("40 53 48 83 EC ? 48 8B 01 48 8B D9 0F 29 7C 24 ? 0F 28 F9 FF 50 ? 84 C0 74 ? 48 8B 5B ? 4C 8D 44 24 ? 0F 29 74 24 ? 48 8D 54 "
        ...
        gPatterns.C_Vehicle__SetDoorFree =
            hook::get_opcode_address("E8 ? ? ? ? 48 8B 5C 24 ? 33 C0 48 8B 74 24 ? 48 83 C4 ? 5F C3 ? ? ? 40 53 48 83 EC ? 45 33 C0 33 D2 48 8B D9 E8 ? ? ? ? 48 8B 43 ? C7 40 ? ? "
        ...
        gPatterns.C_Door__AILock = reinterpret_cast<uint64_t>(
            hook::pattern("40 53 48 83 EC ? F6 81 ? ? ? ? ? 48 8B D9 75 ? 83 B9 ? ? ? ? ? 74 ? E8 ? ? ? ? 48 8B C8 41 B0 ? 48 8B D3 E8 ? ? ? ? 83 8B ? ? ? ? ?").get_first());
        gPatterns.C_Door__Unlock   = hook::get_opcode_address("E8 ? ? ? ? EB ? 83 F8 ? 75 ? 48 8B 83 ? ? ? ?");
        gPatterns.C_Door__AIUnlock = reinterpret_cast<uint64_t>(
            hook::pattern("40 53 48 83 EC ? F6 81 ? ? ? ? ? 48 8B D9 75 ? 83 B9 ? ? ? ? ? 74 ? E8 ? ? ? ? 48 8B C8 41 B0 ? 48 8B D3 E8 ? ? ? ? 83 A3 ? ? ? ? ?").get_first());
